  ...
  return (
    <div className="bg-white px-4 py-6 sm:px-6 lg:px-8 rounded-lg shadow-md">
      <form className="grid gap-4" onSubmit={handleSubmit}>
        <input name="nama" value={form.nama} onChange={handleChange} placeholder="Nama Siswa" className="border rounded px-3 py-2" />
        <input name="kelas" value={form.kelas} onChange={handleChange} placeholder="Kelas" className="border rounded px-3 py-2" />
        <select name="kategori" value={form.kategori} onChange={handleChange} className="border rounded px-3 py-2">
        ...
        {form.kategori && (
          <select name="aksi" value={form.aksi} onChange={handleChange} className="border rounded px-3 py-2">
        ...
        <input name="lokasi" value={form.lokasi} onChange={handleChange} placeholder="Lokasi" className="border rounded px-3 py-2" />
        <input type="date" name="tanggal" value={form.tanggal} onChange={handleChange} className="border rounded px-3 py-2" />
        <input type="number" readOnly value={form.poin} className="border rounded bg-gray-100 px-3 py-2" placeholder="Poin Otomatis" />
        <button type="submit" className="bg-green-600 text-white py-3 px-4 rounded hover:bg-pink-700 transition">Simpan Budaya</button>
      </form>
